...
class PowerToysConfigure {
    ...
    [string] GetPowerToysSettingsPath() {
        $installation = Get-ChildItem HKLM:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\* | ForEach-Object { Get-ItemProperty $_.PsPath } | Where-Object { $_.DisplayName -eq "PowerToys (Preview)" -and $_.DisplayVersion -eq "0.84.1" }

        if (-not $installation)
        {
            $installation = Get-ChildItem HKCU:\SOFTWARE\Microsoft\Windows\CurrentVersion\Uninstall\* | ForEach-Object { Get-ItemProperty $_.PsPath } | Where-Object { $_.DisplayName -eq "PowerToys (Preview)" -and $_.DisplayVersion -eq "0.84.1" }
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAkreVx8COu39TD
# fSEiulwb0H4ay+KAN9anjcoFKa1RYqCCDXYwggX0MIID3KADAgECAhMzAAADrzBA
...
# MAwGCisGAQQBgjcCARUwLwYJKoZIhvcNAQkEMSIEIHXjPT4IA3y0g+54PpUMfA1u
# 4p4nwf13lfOLz/Rrot9NMEIGCisGAQQBgjcCAQwxNDAyoBSAEgBNAGkAYwByAG8A
# cwBvAGYAdKEagBhodHRwOi8vd3d3Lm1pY3Jvc29mdC5jb20wDQYJKoZIhvcNAQEB
# BQAEggEAU11mxuVSOx+Z18bQyQsKNr4dcW9lno/NNyMNK+JfUaxBdPdmkkYoymuP
# Wbk/0OK+E4mGSwiSgk+y+GCcUhvknyivdeL+UZMaeUTYo3p1UWSg9z17Ay00kJhT
# A6R/JvY14biCjNaRz5caBZQwe/8paP3h3liq7XY7xmBh1btS5ADEk0Bz02LtAk37
# tmJ1EhKH4qdt/tR7JDwmWunfhVOPYgozmAz8s3Q1LoiuAAelW9I9PeKVuh+mQ4m8
# lhrnD0BTagjimquS00Y2w8AXR2ASpf1X6Pafm0smo+8W7FYUas1BtdIG6wfqTU0z
# HwUx9wVrG8fUf5HAVwZWKbrj3VtJaaGCF5QwgheQBgorBgEEAYI3AwMBMYIXgDCC
# F3wGCSqGSIb3DQEHAqCCF20wghdpAgEDMQ8wDQYJYIZIAWUDBAIBBQAwggFSBgsq
# hkiG9w0BCRABBKCCAUEEggE9MIIBOQIBAQYKKwYBBAGEWQoDATAxMA0GCWCGSAFl
# AwQCAQUABCDDxs7lPSBw491TaC/WaKlyAwo337TwIqFL/M7wyw6KnAIGZr4Pku7H
# GBMyMDI0MDkwNTE5MTQwMi44NjdaMASAAgH0oIHRpIHOMIHLMQswCQYDVQQGEwJV
...
# IFBDQSAyMDEwMA0GCSqGSIb3DQEBCwUAAgUA6oQ7nDAiGA8yMDI0MDkwNTE0MTU1
# NloYDzIwMjQwOTA2MTQxNTU2WjB0MDoGCisGAQQBhFkKBAExLDAqMAoCBQDqhDuc
# AgEAMAcCAQACAhImMAcCAQACAhRtMAoCBQDqhY0cAgEAMDYGCisGAQQBhFkKBAIx
# KDAmMAwGCisGAQQBhFkKAwKgCjAIAgEAAgMHoSChCjAIAgEAAgMBhqAwDQYJKoZI
# hvcNAQELBQADggEBAF42wfvHALX/LopuLnHeMrRWoP7LMaS27PaQjukC9ks6Da2u
# iC8MGMNmPKduZDXoOm9jlnSQxopLXgcq4GqTZLOHHUKNE/um3VugLPY6bKVGErDh
# JOdEv7SV5A3rHRRdySNyqQrUVEQcMV9F3oKHZjjvzT5+gTG5LPSCKVwv29EnYoZk
# L58A3zVrgzWaHGuUj/3XRFZ5MMw1X3/fSEqNN432EmKXupdlH+oT7NCQ7UxepcTc
# O31chhqr0LLLsrwaJHLwZbvcSSh5Zala1ayN93o6CFoAY22X/EaLlHU4k8VVC9pd
# rW2oPq5EMAYyShFzFmYaRFKxHDM9abakKwTn5i8xggQNMIIECQIBATCBkzB8MQsw
# CQYDVQQGEwJVUzETMBEGA1UECBMKV2FzaGluZ3RvbjEQMA4GA1UEBxMHUmVkbW9u
# ZDEeMBwGA1UEChMVTWljcm9zb2Z0IENvcnBvcmF0aW9uMSYwJAYDVQQDEx1NaWNy
# b3NvZnQgVGltZS1TdGFtcCBQQ0EgMjAxMAITMwAAAehQsIDPK3KZTQABAAAB6DAN
# BglghkgBZQMEAgEFAKCCAUowGgYJKoZIhvcNAQkDMQ0GCyqGSIb3DQEJEAEEMC8G
# CSqGSIb3DQEJBDEiBCBc/zAyFysmXqAOjxrag5VO6LpGDFHOeExjIUYmcRPaSzCB
...
# MTACEzMAAAHoULCAzytymU0AAQAAAegwIgQgh1/TvP38Qi7PnLEbQ3NmDiAfLvWq
# IFm6n/3NZkSe1CMwDQYJKoZIhvcNAQELBQAEggIAW7J4DZ1cCqyYLkQbDs4P4ykZ
# pLRAqpY+fFWSCt8OgKj9TIaVxk1EwfpdqL1d0T8CIeGWyTwz+k/H4JuFOFXkP/cN
# W3CpGYS7lAy+uAXN2SH6STa9PvOgXcOoD+KncF2hRYSL6KuDvQcqZHwU678eN+u2
# UzmZwoC/r+1osM+IZVjs9MbYImCTHLNe9gFRJTXggYnWBoAA4GAwtGM9jC3vHZRB
# Aj9Uky+wnj+ZspQJcwxewxG/VQLmSiFeznID1E+CaqrcZi0UOSiS+FLCd7HXV8GJ
# vRyEN1q1TNpdq4nhSrEXc1MBo0+QMjYVnAo0syg4RTtr3iUShvAxD8MiDRnFeJYK
# d2LV78jGaEwYEBuA20+Lv7yC4Eg5IdFDi7yzBqxMhkXDi3WDUFIDlA/djVaz4YxA
# YLkbv06S37KwEkBEz2npXql3St7PTfNm76CTn6EF+9+QweDjOKVv8AYEsDRqGqfB
# kbDGlegpIgxvJCT34v0wmBmxKhbSPNNYJ93DcGD5xuH26CAHnwmI5OTC9g/La8Vb
# T3dZ4WROQBLWHfmyS6QfC6wIVJywtJ2DlG8OSh0IEECeknkQtKVHjDTr3wvQ9gOs
# VsHzQRGQZ++47BtieajNkmZrDxOGYd/rejJSVQUWdc5O+X8nA50n50QCpsqkHDnW
# FdUh4Yzh4NPLPj9X324=
